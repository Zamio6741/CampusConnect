                    ...
                    <div class="flex items-center gap-3 sm:gap-4">
                        ...
                        <div class="relative">
                            ...
                            >
                                ...
                                <span class="text-lg sm:text-xl leading-none">
                                    🔔
                                </span>
                            ...
                            <div
                                id="notificationMenu"
                                class="hidden fixed inset-x-3 top-[5.5rem] sm:absolute sm:inset-x-auto sm:top-auto sm:right-0 sm:mt-3 w-auto sm:w-96 max-w-none sm:max-w-sm bg-white rounded-2xl shadow-2xl border border-slate-200 z-[100] overflow-hidden"
                            >

                                {{-- Header --}}
                                <div class="flex items-center justify-between gap-3 p-4 sm:p-5 border-b border-slate-100">
                                    ...
                                    @if($unreadNotificationCount > 0)
                                        ...
                                        >
                                            ...
                                            <button
                                                type="submit"
                                                class="text-sky-600 hover:text-sky-700 active:text-sky-800 text-xs sm:text-sm font-semibold whitespace-nowrap transition"
                                            >
                                                Mark all read
                                            </button>
                                ...
                                {{-- Notification List --}}
                                <div class="max-h-[calc(100vh-8rem)] sm:max-h-96 overflow-y-auto overscroll-contain">

                                    @forelse($notifications->take(8) as $notification)

                                        <div class="p-4 border-b border-slate-100 last:border-b-0 hover:bg-slate-50 active:bg-slate-100 transition">
                                            ...
                                            <div class="flex items-start gap-3">
                                                ...
                                                <div class="flex-1 min-w-0">
                                                    ...
                                                    <div class="flex items-start justify-between gap-2">
                                                        ...
                                                        <h3 class="font-bold text-sm sm:text-base text-slate-800 leading-snug break-words">
                                                            {{ $notification->title }}
                                                        </h3>
                                                    ...
                                                    <p class="text-slate-500 text-xs sm:text-sm mt-1 leading-relaxed break-words">
                                                        {{ $notification->message }}
                                                    </p>

                                                    <div class="flex items-center justify-between gap-3 mt-3">

                                                        <span class="text-[11px] sm:text-xs text-slate-400 whitespace-nowrap">
                                                        ...
                                                        <div class="flex items-center gap-1 shrink-0">
                                                            ...
                                                            @unless($notification->is_read)
                                                                ...
                                                                >
                                                                    ...
                                                                    <button
                                                                        ...
                                                                        title="Mark as read"
                                                                        class="w-8 h-8 rounded-lg flex items-center justify-center hover:bg-green-50 active:bg-green-100 text-green-600 transition"
                                                                    >
                                                                        ✓
                                                                    </button>
                                                            ...
                                                            >
                                                                ...
                                                                <button
                                                                    ...
                                                                    class="w-8 h-8 rounded-lg flex items-center justify-center hover:bg-red-50 active:bg-red-100 text-red-600 transition"
                                                                >
                                                                    🗑
                                                                </button>
                                    ...
                                    @empty
                                        ...
                                        <div class="p-8 sm:p-10 text-center">
                                            ...
                                            <div class="w-14 h-14 mx-auto rounded-2xl bg-slate-100 flex items-center justify-center text-2xl mb-3">
                                                🔔
                                            </div>
                                ...
                                @if($notifications->count() > 8)
                                    ...
                                    <div class="border-t border-slate-100 p-3">
                                        ...
                                        <a
                                            ...
                                            class="inline-flex items-center justify-center w-full rounded-xl bg-slate-50 hover:bg-slate-100 active:bg-slate-200 px-4 py-2.5 text-sm font-semibold text-slate-700 transition"
                                        >
        ...
        <div class="px-4 sm:px-6 lg:px-8 xl:px-10 py-6 sm:py-8 lg:py-10">
            ...
            <div class="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-slate-100 overflow-hidden mt-8 sm:mt-10">
                ...
                <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 px-5 sm:px-6 lg:px-8 py-5 sm:py-6 border-b">
                    ...
                    <a
                        href="{{ route('rental.step1') }}"
                        class="inline-flex justify-center bg-sky-600 hover:bg-sky-700 active:bg-sky-800 text-white px-5 sm:px-6 py-3 rounded-xl font-semibold text-sm sm:text-base transition"
                    >
                        + Add Rental
                    </a>
                                ...
                                <td class="px-6 py-5">
                                    ...
                                    <div class="flex justify-center gap-2">
                                        ...
                                        <a
                                            ...
                                            class="bg-sky-600 hover:bg-sky-700 active:bg-sky-800 text-white px-3 sm:px-4 py-2 rounded-lg text-sm font-semibold transition"
                                        >
                                            View
                                        </a>
                                        ...
                                        <a
                                            ...
                                            class="bg-yellow-500 hover:bg-yellow-600 active:bg-yellow-700 text-white px-3 sm:px-4 py-2 rounded-lg text-sm font-semibold transition"
                                        >
                                            Edit
                                        </a>
                                        ...
                                        >
                                            ...
                                            <button
                                                type="submit"
                                                class="bg-red-600 hover:bg-red-700 active:bg-red-800 text-white px-3 sm:px-4 py-2 rounded-lg text-sm font-semibold transition"
                                            >
                                                Delete
                                            </button>
                        ...
                        @empty
                            ...
                            <tr>
                                ...
                                <td colspan="6" class="text-center py-16 sm:py-20 px-5">
                                    ...
                                    <a
                                        href="{{ route('rental.step1') }}"
                                        class="inline-flex mt-6 bg-sky-600 hover:bg-sky-700 active:bg-sky-800 text-white px-5 sm:px-6 py-3 rounded-xl text-sm sm:text-base font-semibold transition"
                                    >
                                        + Add First Rental
                                    </a>
                            ...
                            <div class="px-5 sm:px-6 lg:px-8 py-5">
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="min-w-0">
                                        ...
                                        <h3 class="font-bold text-slate-800 text-sm sm:text-base break-words">
                                            {{ $notification->title }}
                                        </h3>

                                        <p class="text-gray-500 mt-2 text-sm leading-relaxed break-words">
                                            {{ $notification->message }}
                                        </p>
