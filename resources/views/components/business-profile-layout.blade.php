...
<head>
    ...
    <title>
        {{ config('app.name', 'CampusConnect') }} - Business Profile
    </title>
...
>
    ...
    >
        ...
        >
            ...
            @if(Route::has('businesses.edit') && $businessForLayout)

                <a
                    href="{{ route('businesses.edit', $businessForLayout) }}"
