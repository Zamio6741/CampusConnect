...
<div class="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-5 sm:gap-6 mb-6 sm:mb-8">
    ...
    <div
        class="w-full xl:w-auto xl:min-w-[280px]
    ...
    >
        ...
        <div
            id="liveTime"
            class="text-xl sm:text-2xl lg:text-3xl font-bold tracking-wide mt-1"
        ></div>
...
<div class="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-5 lg:gap-6">

    {{-- TOTAL USERS --}}

    <a
        href="{{ route('admin.users') }}"
        class="block min-w-0 bg-white rounded-2xl shadow-lg p-4 sm:p-5 lg:p-6
    ...
    <div class="min-w-0 bg-white rounded-2xl shadow-lg p-4 sm:p-5 lg:p-6">
...
<div class="mt-8 sm:mt-10">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div class="min-w-0 bg-gradient-to-r from-blue-500 to-blue-700 rounded-2xl p-5 sm:p-6 text-white shadow-xl">
        ...
        <div class="min-w-0 bg-gradient-to-r from-green-500 to-green-700 rounded-2xl p-5 sm:p-6 text-white shadow-xl">
        ...
        <div class="min-w-0 bg-gradient-to-r from-purple-500 to-purple-700 rounded-2xl p-5 sm:p-6 text-white shadow-xl">
...
<div class="mt-6 sm:mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
    ...
    <div class="min-w-0 bg-white rounded-2xl shadow p-4 sm:p-5 lg:p-6">
...
<div class="grid grid-cols-1 xl:grid-cols-3 gap-5 sm:gap-6 mt-6 sm:mt-8 min-w-0">
    ...
    <div class="xl:col-span-2 min-w-0 space-y-5 sm:space-y-6">
...
>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
        ...
        <a
            href="{{ route('admin.users') }}"
            class="group min-w-0 bg-blue-600 text-white rounded-2xl p-5 sm:p-6 lg:p-7
                   text-center hover:-translate-y-1 hover:shadow-xl transition duration-300"
        >
        ...
        <a
            ...
            class="group min-w-0 bg-green-600 text-white rounded-2xl p-5 sm:p-6 lg:p-7
                   text-center hover:-translate-y-1 hover:shadow-xl transition duration-300"
        >
        ...
        <a
            ...
            class="group min-w-0 bg-purple-600 text-white rounded-2xl p-5 sm:p-6 lg:p-7
                   text-center hover:-translate-y-1 hover:shadow-xl transition duration-300"
        >
        ...
        <a
            ...
            class="group min-w-0 bg-orange-500 text-white rounded-2xl p-5 sm:p-6 lg:p-7
                   text-center hover:-translate-y-1 hover:shadow-xl transition duration-300"
        >
        ...
        <a
            ...
            class="group min-w-0 bg-red-600 text-white rounded-2xl p-5 sm:p-6 lg:p-7
                   text-center hover:-translate-y-1 hover:shadow-xl transition duration-300"
        >
        ...
        <a
            ...
            class="group min-w-0 bg-slate-700 text-white rounded-2xl p-5 sm:p-6 lg:p-7
                   text-center hover:-translate-y-1 hover:shadow-xl transition duration-300"
        >
    ...
    <div class="mt-7 sm:mt-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
            ...
            <div class="min-w-0 bg-yellow-100 rounded-2xl p-4 sm:p-5 lg:p-6 border-l-4 sm:border-l-8 border-yellow-500">
            ...
            <div class="min-w-0 bg-blue-100 rounded-2xl p-4 sm:p-5 lg:p-6 border-l-4 sm:border-l-8 border-blue-500">
            ...
            <div class="min-w-0 bg-green-100 rounded-2xl p-4 sm:p-5 lg:p-6 border-l-4 sm:border-l-8 border-green-500">
            ...
            <div class="min-w-0 bg-red-100 rounded-2xl p-4 sm:p-5 lg:p-6 border-l-4 sm:border-l-8 border-red-500">
