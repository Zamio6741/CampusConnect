            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 min-w-0">
                ...
                <div class="min-w-0">
                    ...
                    >
                        ...
                        @foreach($universities as $university)
                            ...
                            <option
                                value="{{ $university->id }}"
                                @selected((string) request('university') === (string) $university->id)
                            >
                                {{ $university->name }}
                            </option>
                ...
                <div class="min-w-0">
                    ...
                    <input
                        ...
                        name="unit"
                        value="{{ request('unit') }}"
                        placeholder="Type unit name or code..."
                        autocomplete="off"
                        class="w-full min-w-0 max-w-full rounded-xl border-2 border-slate-300 bg-white px-4 py-3 text-sm
                               focus:border-sky-500 focus:ring-2 focus:ring-sky-200
                               outline-none"
                ...
                <div class="min-w-0">
                    ...
                    >
                        ...
                        <option
                            value="1"
                            @selected((string) request('premium') === '1')
                        >
                            Premium
                        </option>
                        ...
                        <option
                            value="0"
                            @selected((string) request('premium') === '0')
                        >
                            Free
                        </option>
